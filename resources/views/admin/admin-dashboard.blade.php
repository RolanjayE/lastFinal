...
<head>
    ...
    <x-globalHeaderLink />
    <link rel="stylesheet" href="{{ asset('css/admin/admin-global.css') }}">
...
<body>
    ...
    <div style="min-height: 100vh" class="admin bg-dark text-light">
        ...
        <div class="container-xxl">
            ...
            <div class="admin-header">
                <div class="flex-three">
                    <div class="flex-three-box d-flex">
                        ...
                        <div class="img-admin-logo"><img style="width: 35px; height 35px" src="{{ asset('image/logo2.png') }}" alt=""></div>
                    </div>
            ...
            {{-- this is the header CLOSE--}}


            {{-- this is the Admin main dahboard --}}
                ...
                <div class="admin-center col-lg-6 col-sm-12">
                    ...
                    <div class="center-second mt-4 pt-4">
                        ...
                        <div class="latest-booking">
                            ...
                            <div class="book-box">
                                <div class="img-box">
                                    <img style="border-radius: 10px" width="45px" height="45px" src="{{ asset('image/bed3.jpg') }}" alt="">
                                </div>
                                <div class="info-one">
            ...
            {{-- this is the Admin main dahboard Close--}}
