...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><img style="width: 35px; height: 35px;" src="{{ asset('image/logo2.png') }}" alt=""></a>
        ...
        <div class="collapse navbar-collapse header-a-style" id="navbarSupportedContent">
            ...
            <li class="nav-item"><a class="nav-link active text-uppercase" aria-current="page" href="{{ route('welcome') }}">Home</a> </li>
            <li class="nav-item"><a class="nav-link text-uppercase" href="{{ route('explore') }}" >explore</a></li>
            ...
            <li class="nav-item dropdown header-a-style">
                ...
                <li><a class="dropdown-item text-uppercase" href="{{ route('category') }}">ROOMS</a></li>
